                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"> {/* max width container */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto mb-16 items-stretch">
                        ...
                        <ScrollReveal delay={0.1} className="h-full">
                            <div className="h-full bg-zinc-900/80 backdrop-blur-sm border border-zinc-800 rounded-3xl p-8 hover:border-zinc-700 transition-all duration-300 flex flex-col justify-between group">
                                <div>
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <span className="px-3 py-1 rounded-full text-xs font-bold text-amber-400 bg-amber-950/30 border border-amber-800/40">
                                            Next.js & React
                                        </span>
                                    </div>
                        ...
                        <ScrollReveal delay={0.2} className="h-full">
                            <div className="h-full bg-zinc-900/80 backdrop-blur-sm border-2 border-emerald-500/40 rounded-3xl p-8 shadow-lg shadow-emerald-950/30 flex flex-col justify-between group relative overflow-hidden">
                                <div>
                                    <div className="flex items-center justify-between mb-4">
                                        <h2 className="text-xl font-bold font-display text-zinc-100 group-hover:text-emerald-400 transition-colors">
                                            Letecké dáta & Vizuál
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-full py-3.5 text-center rounded-xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold font-display text-sm transition-all shadow-lg shadow-emerald-950/40"
                                >
                    ...
                    <div className="p-8 sm:p-12 rounded-3xl bg-zinc-900/80 backdrop-blur-sm border border-zinc-800 text-center max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold rounded-xl font-display tracking-wide shadow-lg shadow-emerald-950/40 flex items-center justify-center gap-2"
                            >
