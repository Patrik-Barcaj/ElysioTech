...
export default function About() { // export About component function
    return ( // return JSX layout
        <section id="about" className="py-24 dark:bg-aurora-dark relative border-t border-black/5 dark:border-white/5"> {/* section wrapper */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"> {/* max width container */}
                <div className="text-center mb-16"> {/* header wrapper */}
                    ...
                    <h3 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white font-display">Kto Sme & Čo Robíme</h3> {/* main title */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"> {/* split layout container */}
                    ...
                    <ScrollReveal delay={0.1} className="h-full"> {/* scroll reveal wrap */}
                        <div className="h-full bg-aurora-glass border border-black/10 dark:border-white/10 rounded-3xl p-8 hover:border-aurora-purple/50 hover:bg-gradient-to-br hover:from-white/5 hover:to-aurora-purple/10 hover:-translate-y-3 hover:shadow-[0_15px_40px_-10px_rgba(191,90,242,0.85)] dark:hover:shadow-[0_15px_40px_-10px_rgba(191,90,242,0.4)] transition-all duration-500 flex flex-col justify-between group cursor-pointer relative overflow-hidden"> {/* digital box */}
                            ...
                            <div className="relative z-10"> {/* text block wrapper */}
                                <h4 className="text-2xl font-bold font-display text-gray-900 dark:text-white mb-4 group-hover:text-aurora-purple transition-colors duration-300">Vývoj & <span className="text-aurora-purple">Technológie</span></h4> {/* digital title */}
                                <p className="text-gray-700 dark:text-gray-400 mb-6 leading-relaxed"> {/* desc */}
                                ...
                                <ul className="space-y-3 mb-8"> {/* bullet list */}
                                    <li className="flex items-center text-gray-800 dark:text-gray-300"> {/* bullet item */}
                            ...
                            <div className="relative z-10 aspect-video rounded-2xl overflow-hidden border border-black/5 dark:border-white/5 mt-auto group-hover:border-aurora-purple/40 transition-colors duration-500"> {/* image wrap */}
                    ...
                    <ScrollReveal delay={0.3} className="h-full"> {/* scroll reveal wrap */}
                        <div className="h-full bg-aurora-glass border border-black/10 dark:border-white/10 rounded-3xl p-8 hover:border-aurora-green/50 hover:bg-gradient-to-br hover:from-white/5 hover:to-aurora-green/10 hover:-translate-y-3 hover:shadow-[0_15px_40px_-10px_rgba(48,209,88,0.85)] dark:hover:shadow-[0_15px_40px_-10px_rgba(48,209,88,0.4)] transition-all duration-500 flex flex-col justify-between group cursor-pointer relative overflow-hidden"> {/* air box */}
                            ...
                            <div className="relative z-10"> {/* text block wrapper */}
                                <h4 className="text-2xl font-bold font-display text-gray-900 dark:text-white mb-4 group-hover:text-aurora-green transition-colors duration-300">Kreatíva & <span className="text-aurora-green">Dizajn</span></h4> {/* air title */}
                                <p className="text-gray-700 dark:text-gray-400 mb-6 leading-relaxed"> {/* desc */}
                            ...
                            <div className="relative z-10 aspect-video rounded-2xl overflow-hidden border border-black/5 dark:border-white/5 mt-auto group-hover:border-aurora-green/40 transition-colors duration-500"> {/* image wrap */}
