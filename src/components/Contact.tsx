    ...
    return ( // return JSX layout
        <section id="contact" className="py-24 bg-[#080808] relative border-t border-neutral-800"> {/* section wrapper */}
            ...
            {isSubmitted && ( // popup condition
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm"> {/* overlay */}
                    <div className="bg-[#121214] border border-neutral-800 rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl relative overflow-hidden"> {/* popup container */}
                        <div className="relative z-10"> {/* popup content */}
                            <div className="w-16 h-16 bg-[#00D26A]/20 rounded-full flex items-center justify-center mx-auto mb-6 text-[#00D26A]"> {/* icon container */}
