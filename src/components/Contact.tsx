        ...
        <section id="contact" className="py-24 bg-aurora-dark relative border-t border-white/5"> {/* section wrapper */}
                        ...
                        <div className="h-full flex flex-col justify-center space-y-10 p-4"> {/* contact info column */}
                            <div> {/* support section */}
                                ...
                                <ul className="space-y-4 text-gray-400 text-base leading-relaxed">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span><strong className="text-white">WhatsApp / Instagram / SMS / Mail:</strong> Odpovedáme priebežne počas celého dňa</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="text-aurora-purple mt-0.5">•</span>
                                        <span><strong className="text-white">Telefonáty:</strong> K dispozícii v pracovné dni <strong className="text-white">16:15 – 21:00 <br></br>+ plnohodnotne aj celý víkend</strong></span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <span className="text-aurora-indigo mt-0.5">•</span>
                                        <span><strong className="text-white">Dron & Stretnutia:</strong> Štandardne po 16:30 a po predchádzajúcej dohode kedykoľvek aj počas víkendov. <strong className="text-white"> <br></br></strong></span>
                                    </li>
                                </ul>
                            ...
                            <div> {/* social links block */}
                                ...
                                <div className="flex gap-4"> {/* flex row container */}
                                    <a href="https://wa.me/421903406402" target="_blank" rel="noopener noreferrer" className="relative flex items-center gap-3 px-6 py-3 rounded-full bg-white/5 border border-white/10 text-white overflow-hidden group hover:border-transparent transition-all duration-300"> {/* whatsapp button */}
            ...
            {isSubmitted && ( // popup condition
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm"> {/* overlay */}
                    <div className="bg-aurora-glass border border-white/10 rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl relative overflow-hidden"> {/* popup container */}
                        ...
                        <div className="relative z-10"> {/* popup content */}
                            ...
                            <p className="text-gray-300 mb-8">Ďakujeme za vašu správu. Budeme vás čoskoro kontaktovať.</p> {/* text */}
                            <button onClick={() => setIsSubmitted(false)} className="w-full py-3 bg-white/10 hover:bg-white/20 border border-white/10 text-white rounded-xl font-bold transition-all"> {/* close button */}
                                Zavrieť {/* button text */}
