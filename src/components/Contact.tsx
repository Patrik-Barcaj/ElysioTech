            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"> {/* container block */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-5xl mx-auto items-stretch"> {/* split layout grid */}
                    <ScrollReveal delay={0.1} className="h-full"> {/* left side scroll reveal */}
                        <div className="h-full bg-zinc-900/70 backdrop-blur-sm border border-zinc-800 rounded-3xl p-8 lg:p-10 transition-all duration-300 hover:border-zinc-700 relative overflow-hidden group"> {/* form card container */}
                            <form onSubmit={handleSubmit} className="space-y-5 relative z-10"> {/* form wrapper */}
                                ...
                                <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold font-display rounded-xl text-base tracking-wide transition-all shadow-[0_0_20px_rgba(16,185,129,0.25)] hover:shadow-[0_0_30px_rgba(16,185,129,0.35)] transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"> {/* submit button */}
                        ...
                        <div className="h-full flex flex-col justify-between space-y-8 p-4"> {/* contact info column */}
                            <div> {/* support section */}
                                ...
                                <ul className="space-y-4 text-zinc-400 text-sm sm:text-base leading-relaxed">
                                    <li className="flex items-start gap-3 p-3 rounded-2xl bg-emerald-950/30 border border-emerald-800/40">
                            ...
                            <div> {/* direct action buttons block */}
                                ...
                                <div className="flex flex-col sm:flex-row gap-3"> {/* flex container */}
                                    ...
                                    <a href="tel:+421903406402" className="flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl bg-zinc-900/70 border border-zinc-800 text-zinc-100 hover:border-emerald-500/40 hover:text-emerald-400 transition-all">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm"> {/* overlay */}
                    <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl relative overflow-hidden"> {/* popup container */}
                        <div className="relative z-10"> {/* popup content */}
                            ...
                            <button onClick={() => setIsSubmitted(false)} className="w-full py-3 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 rounded-xl font-bold transition-all"> {/* close button */}
                                Zavrieť {/* button text */}
