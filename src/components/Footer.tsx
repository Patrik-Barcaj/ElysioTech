...
export default function Footer() { // export Footer component function
    return ( // render return block
        <footer className="bg-[#080808] border-t border-neutral-800 pt-16 pb-12"> {/* footer element */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> {/* wrapper container */}
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12"> {/* layout grid */}
                    ...
                    <div> {/* navigation list column */}
                        <h4 className="text-white font-bold font-display text-sm uppercase tracking-wider mb-4">Navigácia</h4> {/* header */}
                ...
                {/* Trust Badges Bar */}
                <div className="py-4 px-6 rounded-2xl bg-[#121214] border border-neutral-800 flex flex-wrap items-center justify-between gap-4 mb-8 text-xs font-semibold text-zinc-300">
                    ...
                    <span className="flex items-center gap-2">
                        <span className="text-[#00D26A] font-bold">✓</span> Lokalita: Oblasť západného Slovenska
                    </span>
                </div>

                <div className="border-t border-neutral-800 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-zinc-500"> {/* copyright row */}
