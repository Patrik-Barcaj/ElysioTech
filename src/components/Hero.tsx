            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full"> {/* content container */}
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16"> {/* asymmetric split */}
                    ...
                    <div className="flex-1 text-center lg:text-left mt-10 lg:mt-0"> {/* text content wrapper */}
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/40 border border-amber-500/30 text-xs font-display tracking-widest text-amber-400 mb-6"> {/* pre-heading badge */}
                            <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse shadow-[0_0_10px_rgba(245,158,11,0.85)]"></span> {/* glowing dot */}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-10"> {/* cta group */}
                            <a
                                ...
                                className="px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-bold font-display tracking-wide transition-all shadow-lg shadow-emerald-950/40 flex items-center justify-center gap-3 transform hover:-translate-y-0.5"
                            >
                    ...
                    <div className="flex-1 relative w-full max-w-lg hidden lg:block"> {/* image collage wrapper */}
                        <div className="relative w-full aspect-square"> {/* aspect ratio box */}
                            ...
                            <div className="absolute top-0 right-0 w-[82%] h-[78%] border border-zinc-800 rounded-3xl transform rotate-3 hover:rotate-6 hover:scale-105 transition-all duration-700 bg-zinc-900/80 backdrop-blur-sm overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.5)] z-10 hover:z-30 group cursor-pointer"> {/* background card rotated */}
