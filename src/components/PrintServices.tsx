...
export default function PrintServices() { // export print services component
    return ( // return jsx content
        <section id="print" className="py-24 bg-gradient-to-b from-[#0a0715] to-[#0f0a1f] relative border-t border-black/5 dark:border-white/5"> {/* section container */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"> {/* max width content wrapper */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center"> {/* split grid structure */}
                    <div className="relative aspect-video rounded-3xl overflow-hidden border border-black/10 dark:border-white/10 order-2 lg:order-1"> {/* visual element box */}
                    ...
                    <div className="order-1 lg:order-2"> {/* text block wrapper */}
                        ...
                        <h3 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white font-display mb-6 leading-tight"> {/* main title header */}
                            Spolupráca s Tlačiarňami & Tlač {/* text content */}
                        </h3> {/* main title end */}
                        <p className="text-gray-700 dark:text-gray-400 text-lg mb-6 leading-relaxed"> {/* body text paragraph */}
                        ...
                        <div className="space-y-6"> {/* feature list container */}
                            <div className="flex items-start"> {/* list item container 1 */}
                                ...
                                <div> {/* description wrapper */}
                                    <h4 className="text-lg font-bold text-gray-900 dark:text-white font-display mb-1">Bezstarostný proces (Turnkey)</h4> {/* title */}
                                    <p className="text-gray-700 dark:text-gray-400">Pripravíme podklady, skontrolujeme farebnosť, zadáme do výroby a doručíme hotový produkt až k vám.</p> {/* desc */}
                            ...
                            <div className="flex items-start"> {/* list item container 2 */}
                                ...
                                <div> {/* description wrapper */}
                                    <h4 className="text-lg font-bold text-gray-900 dark:text-white font-display mb-1">Široká škála formátov</h4> {/* title */}
                                    <p className="text-gray-700 dark:text-gray-400">Od vizitiek, letákov, brožúr až po veľkoformátové bannery a reklamné predmety.</p> {/* desc */}
                                </div> {/* description wrapper end */}
                            </div> {/* list item end 2 */}
                            <div className="flex items-start"> {/* list item container 3 */}
                                ...
                                <div> {/* description wrapper */}
                                    <h4 className="text-lg font-bold text-gray-900 dark:text-white font-display mb-1">Výhodné ceny a prémiová kvalita</h4> {/* title */}
                                    <p className="text-gray-700 dark:text-gray-400">Vďaka partnerským zľavám vieme ponúknuť priaznivé ceny pri zachovaní najvyššej kvality tlače.</p> {/* desc */}
                                </div> {/* description wrapper end */}
                            </div> {/* list item end 3 */}
