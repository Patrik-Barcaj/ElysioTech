        ...
        <section id="process" className="py-24 bg-gray-50 dark:bg-[#0B0F17] relative border-t border-black/5 dark:border-white/5"> {/* section wrapper */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"> {/* container block */}
                <div className="text-center mb-16"> {/* header block */}
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white font-display">Technický proces realizácie</h2> {/* title */}
                    <p className="text-gray-600 dark:text-gray-400 mt-3 text-base sm:text-lg">Štruktúrovaný postup od analýzy zadania po odovzdanie hotového diela.</p>
