        ...
        <section id="services" className="py-20 min-h-screen flex items-center relative"> {/* main services section */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full"> {/* container */}
                <div className="text-center mb-10"> {/* header wrapper */}
                    ...
                    <h3 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white font-display tracking-tight">Služby <span className="text-transparent bg-clip-text bg-gradient-to-r from-aurora-purple to-aurora-indigo dark:to-aurora-green">ELYSIO</span></h3> {/* main section title */}
                </div> {/* header end */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto"> {/* bento grid container */}
                    ...
                    <ScrollReveal delay={0.1} className="md:col-span-2 md:row-span-1 h-full"> {/* bento item 1 wrapper */}
                        <div className="h-full bg-white shadow-sm dark:shadow-none dark:bg-white/[0.03] border border-black/10 dark:border-white/10 rounded-3xl p-6 hover:bg-black/[0.05] dark:bg-white/[0.05] hover:border-aurora-purple/40 hover:shadow-[0_0_30px_rgba(191,90,242,0.38)] dark:hover:shadow-[0_0_30px_rgba(191,90,242,0.15)] transition-all duration-500 group relative overflow-hidden flex flex-col md:flex-row items-center gap-6"> {/* bento item card */}
                            <div className="flex-1 z-10"> {/* text content */}
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-10 h-10 bg-black/10 dark:bg-white/10 rounded-xl flex items-center justify-center border border-black/5 dark:border-white/5 group-hover:scale-110 group-hover:border-aurora-purple/50 group-hover:bg-aurora-purple/20 transition-all duration-500 shrink-0"> {/* icon wrapper */}
                                        <svg className="w-5 h-5 text-gray-900 dark:text-white group-hover:text-aurora-purple transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg> {/* web icon */}
                                    </div> {/* icon wrapper end */}
                                    <h4 className="text-xl font-display font-bold text-gray-900 dark:text-white group-hover:text-aurora-purple transition-colors duration-500">Tvorba webov & Aplikácií</h4> {/* title */}
                                </div>
                                <ul className="text-gray-700 dark:text-gray-400 text-base leading-relaxed space-y-2"> {/* desc list */}
                            ...
                            <div className="w-full md:w-1/2 h-40 rounded-xl overflow-hidden relative border border-black/5 dark:border-white/5 group-hover:border-black/10 dark:border-white/10 transition-colors duration-500 shrink-0"> {/* image content */}
                    ...
                    <ScrollReveal delay={0.2} className="md:col-span-1 md:row-span-1 h-full"> {/* bento item 2 wrapper */}
                        <div className="h-full bg-white shadow-sm dark:shadow-none dark:bg-white/[0.03] border border-black/10 dark:border-white/10 rounded-3xl p-6 hover:bg-black/[0.05] dark:bg-white/[0.05] hover:border-aurora-green/40 hover:shadow-[0_0_30px_rgba(161,255,206,0.38)] dark:hover:shadow-[0_0_30px_rgba(161,255,206,0.15)] transition-all duration-500 group relative overflow-hidden flex flex-col justify-center"> {/* bento item card */}
                            <div className="z-10 relative"> {/* content */}
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="w-10 h-10 bg-black/10 dark:bg-white/10 rounded-xl flex items-center justify-center border border-black/5 dark:border-white/5 group-hover:scale-110 group-hover:border-aurora-green/50 group-hover:bg-aurora-green/20 transition-all duration-500 shrink-0"> {/* icon wrapper */}
                                        <svg className="w-5 h-5 text-gray-900 dark:text-white group-hover:text-aurora-green transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg> {/* drone icon */}
                                    </div> {/* icon wrapper end */}
                                    <h4 className="text-lg font-display font-bold text-gray-900 dark:text-white group-hover:text-aurora-green transition-colors duration-500">Letecké zábery</h4> {/* title */}
                                </div>
                                <ul className="text-gray-700 dark:text-gray-400 text-base leading-relaxed space-y-2"> {/* desc list */}
                    ...
                    <ScrollReveal delay={0.3} className="md:col-span-1 md:row-span-1 h-full"> {/* bento item 3 wrapper */}
                        <div className="h-full bg-white shadow-sm dark:shadow-none dark:bg-white/[0.03] border border-black/10 dark:border-white/10 rounded-3xl p-6 hover:bg-black/[0.05] dark:bg-white/[0.05] hover:border-pink-500/40 hover:shadow-[0_0_30px_rgba(236,72,153,0.38)] dark:hover:shadow-[0_0_30px_rgba(236,72,153,0.15)] transition-all duration-500 group relative overflow-hidden flex flex-col justify-center"> {/* bento item card */}
                            <div className="z-10 relative"> {/* content */}
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="w-10 h-10 bg-black/10 dark:bg-white/10 rounded-xl flex items-center justify-center border border-black/5 dark:border-white/5 group-hover:scale-110 group-hover:border-pink-500/50 group-hover:bg-pink-500/20 transition-all duration-500 shrink-0"> {/* icon wrapper */}
                                    ...
                                    <h4 className="text-lg font-display font-bold text-gray-900 dark:text-white group-hover:text-pink-500 transition-colors duration-500">Grafický dizajn</h4> {/* title */}
                                </div>
                                <ul className="text-gray-700 dark:text-gray-400 text-base leading-relaxed space-y-2"> {/* desc list */}
                    ...
                    <ScrollReveal delay={0.4} className="md:col-span-2 md:row-span-1 h-full"> {/* bento item 4 wrapper */}
                        <div className="h-full bg-white shadow-sm dark:shadow-none dark:bg-white/[0.03] border border-black/10 dark:border-white/10 rounded-3xl p-6 hover:bg-black/[0.05] dark:bg-white/[0.05] hover:border-blue-400/40 hover:shadow-[0_0_30px_rgba(96,165,250,0.38)] dark:hover:shadow-[0_0_30px_rgba(96,165,250,0.15)] transition-all duration-500 group relative overflow-hidden flex flex-col md:flex-row items-center gap-6"> {/* bento item card */}
                            <div className="w-full md:w-5/12 h-36 rounded-xl overflow-hidden relative border border-black/5 dark:border-white/5 group-hover:border-blue-400/30 transition-colors duration-500 shrink-0 order-2 md:order-1"> {/* image content */}
                            ...
                            <div className="flex-1 z-10 order-1 md:order-2"> {/* text content */}
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-10 h-10 bg-black/10 dark:bg-white/10 rounded-xl flex items-center justify-center border border-black/5 dark:border-white/5 group-hover:scale-110 group-hover:border-blue-400/50 group-hover:bg-blue-400/20 transition-all duration-500 shrink-0"> {/* icon wrapper */}
                                    ...
                                    <h4 className="text-xl font-display font-bold text-gray-900 dark:text-white group-hover:text-blue-400 transition-colors duration-500">Sprostredkovanie tlače</h4> {/* title */}
                                </div>
                                <ul className="text-gray-700 dark:text-gray-400 text-base leading-relaxed space-y-2"> {/* desc list */}
