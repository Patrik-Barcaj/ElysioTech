      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto items-stretch mb-12">
          ...
          <ScrollReveal delay={0.1} className="h-full order-1">
            <div className="h-full bg-zinc-900/80 backdrop-blur-sm border-2 border-emerald-500/40 rounded-3xl p-6 sm:p-8 flex flex-col justify-between relative overflow-hidden shadow-[0_0_40px_rgba(16,185,129,0.12)]">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-zinc-900/80 border border-zinc-800 backdrop-blur-sm rounded-3xl p-6 sm:p-8">
            ...
            <div className="space-y-4">
              {comparisonItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-zinc-900/40 border border-zinc-800/60 rounded-2xl p-4 sm:p-5 transition-all hover:border-zinc-700"
                >
