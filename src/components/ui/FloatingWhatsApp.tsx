  ...
  return (
    <aside aria-label="WhatsApp kontakt" className="fixed bottom-6 right-6 z-50 flex items-center group">
      <a
        ...
        className="relative flex items-center gap-3 bg-[#00D26A] hover:bg-[#00B85C] text-black font-extrabold px-4 py-3 rounded-full shadow-lg shadow-[#00D26A]/30 transition-all duration-300 transform hover:-translate-y-1"
      >
