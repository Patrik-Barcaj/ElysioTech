  ...
  return (
    <aside aria-label="WhatsApp kontakt" className="fixed bottom-6 right-6 z-50 flex items-center group">
      <a
        ...
        aria-label="Rýchly kontakt cez WhatsApp"
        className="relative flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba59] text-white px-4 py-3 rounded-full shadow-[0_4px_25px_rgba(37,211,102,0.45)] hover:shadow-[0_6px_30px_rgba(37,211,102,0.6)] transition-all duration-300 transform hover:-translate-y-1"
      >
